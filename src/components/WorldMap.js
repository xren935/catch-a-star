...
//     }
//     componentDidMount(){
//         // use axois to request data 
//         axios.get(WORLD_MAP_URL)
//             .then(res => {
//                 const { data } = res; 
//                 // now let's draw the map  
//                 // use topojson-client 
//                 const map = feature(data, data.objects.countries).features;
//                 this.generateMap(map);
//             })
//             .catch( err => {
//                 console.log(`errrr in fetching world map data`, err);
//             })
//     }
...
//                             .precision(.1);
//         // get the canvas 
//         // use the d3-selection lib to genearte a canvas 
//         const canvas = d3Select(this.refMap.current)
//                         .attr('width', map_width)
//                         .attr('height', map_height);

//         let context = canvas.node().getContext('2d'); 
//         let path = geoPath().projection(projection).context(); 
